...
else
{
    ...
    $result=mysqli_query($con,$q2);
		if($result->num_rows > 0){
			...
			?>
			<form action="updatedata.php?id=<?php echo $row["pid"] ?>" method="post">
				<?php echo "<center>"; ?>
			<div class='box'>
...
<div>
<label class="text"><INPUT TYPE="TEXT" class="textbox" value="<?php echo $row['centerid'] ?>" required="" NAME="cid"
placeholder="FULL ADDRESS" STYLE="HEIGHT:80px;
WIDTH:150px;"></label><BR><BR>
<label>Center Name:</label>
<div>
<label class="text"><INPUT TYPE="TEXT" class="textbox" value="<?php echo $row['centername'] ?>" required="" NAME="cname"
placeholder="FULL ADDRESS" STYLE="HEIGHT:80px;
WIDTH:150px;"></label><BR><BR>
<label>Status:</label>
<div>
<label class="text"><INPUT TYPE="TEXT" class="textbox" value="<?php echo $row['stat'] ?>" NAME="stat"
