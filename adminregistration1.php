...
$alertmsg="<div style='color:blue;'><a href='adminlogin.php' style='text-decoration:none;'>GO TO LOGIN</a>"."&nbsp &nbsp &nbsp"."<a href='adminregistration.php' style='text-decoration:none;color:blue'>REGISTER AGAIN</a></div>";
if($password==$repassword)
{
$q1="select * from admins where fname='$fname' and lname='$lname' and email='$email' and password='$password' and contactnum='$contactnum' and gender='$gender'";
...
if($num){
	...
	$q2="insert into admins (fname,lname,email,password,gender,contactnum) values ('$fname','$lname','$email','$password','$gender','$contactnum')";
	mysqli_query($con,$q2);
	$salert=1;
}
}
